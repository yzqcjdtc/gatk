...
//        copyRatioMidpointOverlapDetector = denoisedCopyRatiosFirstSample.getMidpointOverlapDetector();
//        allelicCountOverlapDetector = allelicCountsFirstSample.getOverlapDetector();
//        final int numAllelicCountsToUse = (int) denoisedCopyRatiosFirstSample.getRecords().stream()
...
//        multidimensionalPointsPerChromosome = denoisedCopyRatiosFirstSample.getRecords().stream()
