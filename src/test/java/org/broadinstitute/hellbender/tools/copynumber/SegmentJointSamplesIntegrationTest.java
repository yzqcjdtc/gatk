...
import org.broadinstitute.hellbender.tools.copynumber.segmentation.MultisampleMultidimensionalKernelSegmenterUnitTest;
...
/**
 * Integration tests for {@link SegmentJointSamples}.  We test for input validation across various run modes of the tool
 * and for consistency of metadata in output, but do not test for correctness of output (which is tested elsewhere,
 * e.g. {@link MultisampleMultidimensionalKernelSegmenterUnitTest}).
 *
 * @author Samuel Lee &lt;slee@broadinstitute.org&gt;
 */
public final class SegmentJointSamplesIntegrationTest extends CommandLineProgramTest {
...
//        final File outputDir = new File("/home/slee/working/sjs-test"); //createTempDir("testDir");
...
//                .addOutput(new File(outputDir, outputPrefix + ".seg"));
